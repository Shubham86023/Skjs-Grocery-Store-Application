  ...
  (e = (function () {
    ...
    (e.prototype.autoPlayIterator = function () {
      ...
      i.paused ||
        i.interrupted ||
        i.focussed ||
        (i.options.infinite === !1 && (1 === i.direction && i.currentSlide + 1 === i.slideCount - 1 ? (i.direction = 0) : 0 === i.direction && ((e = i.currentSlide - i.options.slidesToScroll), i.currentSlide - 1 === 0 && (i.direction = 1))), i.slideHandler(e));
    }),
      ...
      if (("window" === r.respondTo ? (n = d) : "slider" === r.respondTo ? (n = a) : "min" === r.respondTo && (n = Math.min(d, a)), r.options.responsive && r.options.responsive.length && null !== r.options.responsive)) {
        ...
        null !== o
          ? null !== r.activeBreakpoint
            ? (o !== r.activeBreakpoint || t) && ((r.activeBreakpoint = o), "unslick" === r.breakpointSettings[o] ? r.unslick(o) : ((r.options = i.extend({}, r.originalSettings, r.breakpointSettings[o])), e === !0 && (r.currentSlide = r.options.initialSlide), r.refresh(e)), (l = o))
            : ((r.activeBreakpoint = o), "unslick" === r.breakpointSettings[o] ? r.unslick(o) : ((r.options = i.extend({}, r.originalSettings, r.breakpointSettings[o])), e === !0 && (r.currentSlide = r.options.initialSlide), r.refresh(e)), (l = o))
      ...
      return (
        ...
        n.options.infinite === !0
          ? (n.slideCount > n.options.slidesToShow &&
              ((n.slideOffset = -1 * (n.slideWidth * n.options.slidesToShow + a + i * r)), (o = -1), n.options.vertical === !0 && n.options.centerMode === !0 && (2 === n.options.slidesToShow ? (o = -1.5) : 1 === n.options.slidesToShow && (o = -2)), (l = e * n.options.slidesToShow * o)),
    ...
    (e.prototype.keyHandler = function (i) {
      ...
      i.target.tagName.match("TEXTAREA|INPUT|SELECT") ||
        (37 === i.keyCode && e.options.accessibility === !0 ? e.changeSlide({ data: { message: e.options.rtl === !0 ? "next" : "previous" } }) : 39 === i.keyCode && e.options.accessibility === !0 && e.changeSlide({ data: { message: e.options.rtl === !0 ? "previous" : "next" } }));
    }),
    ...
    (e.prototype.progressiveLazyLoad = function (e) {
      ...
      a.length
        ? ((t = a.first()),
          ...
          (r.onload = function () {
            o && (t.attr("srcset", o), n && t.attr("sizes", n)), t.attr("src", s).removeAttr("data-lazy data-srcset data-sizes").removeClass("slick-loading"), l.options.adaptiveHeight === !0 && l.setPosition(), l.$slider.trigger("lazyLoaded", [l, t, s]), l.progressiveLazyLoad();
          }),
          (r.onerror = function () {
            3 > e
              ? setTimeout(function () {
    ...
    (e.prototype.setCSS = function (i) {
      ...
      s.options.rtl === !0 && s.options.vertical === !1 && (i = -i),
        ...
        (o[s.positionProp] = i),
        s.transformsEnabled === !1 ? s.$slideTrack.css(o) : ((o = {}), s.cssTransitions === !1 ? ((o[s.animType] = "translate(" + e + ", " + t + ")"), s.$slideTrack.css(o)) : ((o[s.animType] = "translate3d(" + e + ", " + t + ", 0px)"), s.$slideTrack.css(o)));
    }),
    (e.prototype.setDimensions = function () {
      ...
      (s = i.getValueMargin()),
        ...
        i.options.vertical === !1 ? i.options.centerMode === !0 && i.$list.css({ padding: "0px " + i.options.centerPadding }) : (i.$list.height(i.$slides.first().outerHeight(!0) * i.options.slidesToShow - s), i.options.centerMode === !0 && i.$list.css({ padding: i.options.centerPadding + " 0px" })),
    ...
    (e.prototype.setFade = function () {
      ...
      t.$slides.each(function (s, o) {
        (e = t.slideWidth * s * -1), t.options.rtl === !0 ? i(o).css({ position: "relative", right: e, top: 0, zIndex: t.options.zIndex - 2, opacity: 0 }) : i(o).css({ position: "relative", left: e, top: 0, zIndex: t.options.zIndex - 2, opacity: 0 });
      }),
      ...
      function () {
        ...
        if (
          ("object" === i.type(arguments[0])
            ...
            : "string" === i.type(arguments[0]) && ((s = arguments[0]), (o = arguments[1]), (l = arguments[2]), "responsive" === arguments[0] && "array" === i.type(arguments[1]) ? (n = "responsive") : "undefined" != typeof arguments[1] && (n = "single")),
          "single" === n)
        )
          r.options[s] = o;
        else if ("multiple" === n)
          ...
          : ((o = r.slideCount % r.options.slidesToShow),
            ...
            r.options.slidesToShow == r.options.slidesToScroll && r.slideCount - i < r.options.slidesToShow
              ...
              : t
                  ...
                  .addClass("slick-active")
                  .attr("aria-hidden", "false"));
      ("ondemand" === r.options.lazyLoad || "anticipated" === r.options.lazyLoad) && r.lazyLoad(), r.$slider.find(".slick-active:first").addClass("first-slick").siblings().removeClass("first-slick"), r.$slider.find(".slick-active:last").addClass("last-slick").siblings().removeClass("last-slick");
    }),
          ...
          : (e === !1 && d.asNavFor(i),
            ...
            d.options.infinite === !1 && d.options.centerMode === !1 && (0 > i || i > d.getDotCount() * d.options.slidesToScroll)
              ...
              : (d.options.autoplay && clearInterval(d.autoPlayTimer),
                (o = 0 > s ? (d.slideCount % d.options.slidesToScroll !== 0 ? d.slideCount - (d.slideCount % d.options.slidesToScroll) : d.slideCount + s) : s >= d.slideCount ? (d.slideCount % d.options.slidesToScroll !== 0 ? 0 : s - d.slideCount) : s),
                (d.animating = !0),
    ...
    (e.prototype.swipeDirection = function () {
      ...
      return (
        ...
        45 >= s && s >= 0 ? (o.options.rtl === !1 ? "left" : "right") : 360 >= s && s >= 315 ? (o.options.rtl === !1 ? "left" : "right") : s >= 135 && 225 >= s ? (o.options.rtl === !1 ? "right" : "left") : o.options.verticalSwiping === !0 ? (s >= 35 && 135 >= s ? "down" : "up") : "vertical"
      );
    }),
          ...
          : ((e = l.getLeft(l.currentSlide)),
            ...
            !l.options.verticalSwiping && !l.swiping && r > 4
              ...
              : (l.options.verticalSwiping === !0 && (l.touchObject.swipeLength = r),
                ...
                l.options.infinite === !1 && ((0 === l.currentSlide && "right" === t) || (l.currentSlide >= l.getDotCount() && "left" === t)) && ((s = l.touchObject.swipeLength * l.options.edgeFriction), (l.touchObject.edgeHit = !0)),
      ...
      (i = Math.floor(e.options.slidesToShow / 2)),
        e.options.arrows === !0 &&
          ...
          0 === e.currentSlide
            ...
            : e.currentSlide >= e.slideCount - 1 && e.options.centerMode === !0 && (e.$nextArrow.addClass("slick-disabled").attr("aria-disabled", "true"), e.$prevArrow.removeClass("slick-disabled").attr("aria-disabled", "false")));
    }),
